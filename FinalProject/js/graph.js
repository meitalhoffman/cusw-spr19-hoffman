...
//     this.gridX = int(x/scale);
//     this.gridY = int(y/scale);
//   }
...
//         this.nodes.add(new Node(i*SCALE + scale/2, j*SCALE + scale/2, scale));
//       }
//     }
//     generateEdges();
//   }
...
//     let numWays = ways.size();
//     for (let i=0; i<numWays; i++) {
//       var numNodes = ways.get(i).coordinates.size();
//       for (let j=0; j<numNodes; j++) {
        
//         var x = ways.get(i).coordinates.get(j).x;
//         var y = ways.get(i).coordinates.get(j).y;
//         var coord = createVector(x, y);
//         var screenLocation = map.getScreenLocation(coord);
//         var n = new Node(screenLocation.x, screenLocation.y, scale);
//         n.ID = i;
//         n.clearNeighbors();
//         this.nodes.add(n);
//       }
...
//     var objectID, lastID = -1;
//     var dist;

//     for (let i=0; i<this.nodes.size(); i++) {
      
//       if (i != 0) lastID   = this.nodes.get(i-1).ID;
//       objectID = this.nodes.get(i).ID;
//       if (lastID == objectID) {
//         dist = sqrt(sq(this.nodes.get(i).loc.x - this.nodes.get(i-1).loc.x) + sq(this.nodes.get(i).loc.y - this.nodes.get(i-1).loc.y));
//         this.nodes.get(i).addNeighbor(i-1, dist);
//       }
//     }
