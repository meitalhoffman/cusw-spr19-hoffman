        ...
        while (!startOpenList.empty() && !endOpenList.empty()) {
            ...
            for (i = 0, l = neighbors.length; i < l; ++i) {
                ...
                if (!neighbor.opened || ng < neighbor.g) {
                    neighbor.g = ng;
                    neighbor.h = neighbor.h || weight * heuristic.manhattan(abs(x - endNode.x), abs(y - endNode.y), abs(z - endNode.z));
            ...
            for (i = 0, l = neighbors.length; i < l; ++i) {
                ...
                if (!neighbor.opened || ng < neighbor.g) {
                    neighbor.g = ng;
                    neighbor.h = neighbor.h || weight * heuristic.manhattan(abs(x - startNode.x), abs(y - startNode.y), abs(z - startNode.z));
                    neighbor.f = neighbor.g + neighbor.h;
                    neighbor.parent = node;
