...
class Camera {
  ...
  // UI: Chunks used for selecting area in 3D
  //
  int CHUNK_RESOLUTION = 5; // length of chunk units
  ...
  void init() {
    ...
    hs = new HScrollbar(width/2 - thirdPix/2, height - 1.5*margin, thirdPix, margin+10, 10);
    
    // Initialize Vertical Scrollbar
    vs = new VScrollbar(eX + eW - int(1.5*margin), margin, margin+10, thirdPix, 10);
